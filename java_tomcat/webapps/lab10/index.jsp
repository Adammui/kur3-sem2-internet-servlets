...
<div style="margin-left: 500px; margin-top: 150px;">
    ...
    <form action="DBConnection2" method="get">
        ...
        <input type="submit" value="task 3 (select with marker)" size="20">
    </form>
    <form action="DBConnection3" method="get">
        <input id="name" name="name" placeholder="put here name">
        <input type="submit" value="task 4 (call stored procedure- adding new line)" size="20">
    </form>
